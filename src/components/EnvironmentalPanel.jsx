 ...
 */
const EnvironmentalPanel = ({ currentData, trends, expanded = false, className = '' }) => {
  ...
  const getColorClasses = (color) => {
    const colors = {
      blue: isDarkMode ? 'text-blue-400 bg-blue-900' : 'text-blue-600 bg-blue-50',
      cyan: isDarkMode ? 'text-cyan-400 bg-cyan-900' : 'text-cyan-600 bg-cyan-50',
      green: isDarkMode ? 'text-green-400 bg-green-900' : 'text-green-600 bg-green-50',
      yellow: isDarkMode ? 'text-yellow-400 bg-yellow-900' : 'text-yellow-600 bg-yellow-50',
      orange: isDarkMode ? 'text-orange-400 bg-orange-900' : 'text-orange-600 bg-orange-50',
      red: isDarkMode ? 'text-red-400 bg-red-900' : 'text-red-600 bg-red-50',
      gray: isDarkMode ? 'text-gray-400 bg-gray-700' : 'text-gray-600 bg-gray-50'
    };
